...
function BestViewAsk() {
  ...
  const getAsks = (body) => {
    axios.post('/api/ask/view', body).then((response) => {
  ...
  return (
    <div className="best-view-ask">
      <div className="ask-title">
        <h2>많이 본 청원 게시글 Top 3</h2>
        <p>가장 조회수가 높은 청원글을 응원해보세요!</p>
      </div>
