            ...
            <div className="comment-box">
              <div className="comment-info">
                ...
                {/* <div className="reply-btn">
                  <SingleComment comment={comment} askId={props.askId} update={props.update} />
                  <Reply comments={props.comments} parentCommentId={comment._id} askId={props.askId} update={props.update} />
                </div> */}
              </div>
            </div>
          </div>
